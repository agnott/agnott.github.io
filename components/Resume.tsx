    ...
    <React.Fragment>
      ...
      <EntryContainer>
        ...
        <Overview>
          ...
          client, and server experience. Has helped build and scale a small startup into a
          billion-dollar business. A bias for action and eagerness to learn lead to
      ...
      <EntryContainer>
        ...
        <PositionDetails>
          <PositionDetail>
            ...
            up to four engineers. Designed and implemented the initial messaging feature, which has
            evolved to support Fan Clubs &ndash; controlled, feature-rich group chats of 50,000+
            users.
          </PositionDetail>
          <PositionDetail>
            Served as the initial lead for the Growth team. Collaborated and supervised a team of up
            to three engineers. Designed and implemented multiple high-impact experiments,
          ...
          <PositionDetail>
            ...
            service and migrated from Expo&apos;s ExpoKit to their Bare Workflow. Decreased both
            crash percentage and median app startup time by 30%.
          </PositionDetail>
          <PositionDetail>
...
const Header = styled.div`
  ...
  padding: ${Spacing.small}px ${Spacing.medium + Spacing.small}px;
  margin: ${Spacing.invert(Spacing.small)}px ${Spacing.invert(Spacing.small)}px 0px
    ${Spacing.invert(Spacing.small)}px;
  display: flex;
  flex-direction: row;
...
const Overview = styled.div`
  ${Fonts.regular[300]}
  margin: ${Spacing.xxSmall}px ${Spacing.small}px ${Spacing.small}px ${Spacing.small}px;
`;
